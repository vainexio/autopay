...
module.exports = {
  generateQr: async function (amount,name,plain,platform) {
    ...
    //let kira  = "000201"+initial+"27830012com.p2pqrpay0111GXCHPHM2XXX02089996440303152170200000006560417DWQM4TK3JDNWLLAJW520460165303608"+(Number(amount) > 0 ? digitIndicator + Number(amount).toFixed(2) : "")+"5802PH59"+formatNumber(name.length)+name+"6014Central Signal610412346304"

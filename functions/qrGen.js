...
module.exports = {
  generateQr: async function (amount,name,plain,platform) {
    ...
    let iphone_gcash = "000201"+initial+"27830012com.p2pqrpay0111GXCHPHM2XXX02089996440303152170200000006560417DWQM4TK3JDO7SRDOU520460165303608"+(Number(amount) > 0 ? digitIndicator + Number(amount).toFixed(2) : "")+"5802PH59"+formatNumber(name.length)+name+"6011San Antonio610412346304";
    let oppo_gcash  =  "000201"+initial+"27830012com.p2pqrpay0111GXCHPHM2XXX02089996440303152170200000006560417DWQM4TK3JDO5YAWDV520460165303608"+(Number(amount) > 0 ? digitIndicator + Number(amount).toFixed(2) : "")+"5802PH59"+formatNumber(name.length)+name+"6011San Antonio610412346304";
    platform == "iphone_gcash" ? qrData = iphone_gcash :
    platform == "maya" ? qrData = maya : 
      platform == "oppo_gcash" ? qrData = oppo_gcash : null

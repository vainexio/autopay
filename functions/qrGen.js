...
module.exports = {
  generateQr: async function (amount,name,plain) {
    ...
    let digitIndicator =
      ...
      : amount >= 1 ? "4"
      : "Unknown";
    let qrData = "00020101021227830012com.p2pqrpay0111GXCHPHM2XXX02089996440303152170200000006560417DWQM4TK3JDO7RNEYM520460165303608540"+digitIndicator+amount.toFixed(2)+"5802PH59"+formatNumber(name.length)+name+"6011San Antonio610412346304"
